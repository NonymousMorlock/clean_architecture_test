...
class DataConnectionChecker {
  ...
  Future<AddressCheckResult> isHostReachable(
    ...
    try {
      sock = await Socket.connect(
        ...
        ..destroy();
      return AddressCheckResult(options: options, isSuccess: true);
    } catch (e) {
      sock?.destroy();
      return AddressCheckResult(options: options, isSuccess: false);
    }
  }
  ...
  Future<bool> get hasConnection async {
    final requests = <Future<AddressCheckResult>>[];
...
class AddressCheckResult {
  AddressCheckResult({required this.options, required this.isSuccess});
